...
SYSTEM_PROMPT = """
    ...
    PLAN: { "step": "OBSERVE", "tool": "get_weather" "input": "the temperature of delhi is cloudy with 20 deg C" 
    PLAN: { "step": "PLAN", "content": "Great i got the weather info about delhi" 
    OUTPUT: { "step": "OUTPUT", "content": "The current weather in delhi is 20 deg C with some cloudy sky." 
    }
"""
...
while True:
    ...
    while True:
        ...
        if parsed_result.step == "START":
            print("User:", parsed_result.content)
            continue
        ...
        if parsed_result.step == "PLAN":
            print("Brain:", parsed_result.content)
            continue

        if parsed_result.step == "OUTPUT":
            print("Boat:", parsed_result.content)
            break
...
# Use OpenAI real for better result the gemini is not that good it throws error piyush is code working fine and he's using openai